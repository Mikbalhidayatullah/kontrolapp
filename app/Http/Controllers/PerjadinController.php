    ...
    public function show(Request $request, PerjadinEntry $perjadinEntry): View
    {
        ...
        return view('perjadin-show', [
            ...
            'receiptDefaults' => [
                ...
                'received_from' => old('received_from', 'Bendahara Pengeluaran Dinas Pendidikan dan Kebudayaan, Provinsi Maluku Utara'),
                ...
                'approver_nip' => old('approver_nip', '19730524 20012 1 002'),
                'treasurer_name' => old('treasurer_name', 'Vivi Iriyanti, ST'),
                'treasurer_nip' => old('treasurer_nip', '19810131 201001 2 014'),
            ],
        ]);
    }
